        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde sus inicios, la Investigación de Operaciones (IO) ha sido una herramienta clave para la optimización y la toma de decisiones estratégicas en organizaciones de diversos sectores. Su origen se remonta a la Segunda Guerra Mundial, cuando se utilizó para mejorar la logística y la planificación militar. Hoy en día, la IO se ha consolidado como una disciplina esencial para la gestión eficiente de los recursos, permitiendo a las empresas mejorar su productividad, reducir costos y optimizar procesos a través de modelos matemáticos, técnicas estadísticas y herramientas computacionales.
              
              p #[b ¡Prepárese para descubrir cómo la Investigación de Operaciones transforma los procesos empresariales y facilita la toma de decisiones basadas en datos!]
